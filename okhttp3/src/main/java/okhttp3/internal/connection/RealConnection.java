...
/**
 * 连接有三种代理：http代理、https代理、socks代理
 * 1. http代理：将请求的域名+路径放到请求头中，无代理时只有路径没有域名
 * 2. https代理：先向目标服务器发送一个 connect，然后再正常发送
 * 3. socks代理：创建socket时，直接将代理传入
 */
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int connectTimeout, int readTimeout, Call call,
        ...
        //todo socks代理时，直接把代理信息传到socket中
